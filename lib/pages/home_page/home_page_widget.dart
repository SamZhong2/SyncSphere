...
import '/components/project_item_widget.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final itemsList =
                            FFAppState().ProjectTitleList.toList();
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, itemsListIndex) {
                            ...
                            return Container(
                              ...
                              child: Visibility(
                                visible:
                                    FFAppState().ProjectTitleList.length > 0,
                                child: ProjectItemWidget(
                                  key: Key(
                                      'Keyiq2_${itemsListIndex}_of_${itemsList.length}'),
                                  itemTitle: FFAppState()
                                      .ProjectTitleList
                        ...
                        children: [
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'HOME_PAGE_PAGE_RATE_OUR_APP_BTN_ON_TAP');
