...
class LoginWidget extends StatefulWidget {
  ...
  static String routePath = '/Signup/Login';
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        indicatorColor: Color(0xFFDBA6A6),
                        tabs: [
                          Tab(
                            text: 'Signup',
                          ),
                          Tab(
                            key: ValueKey('Tab_yws6'),
                            text: 'Login',
                          ),
                        ],
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 4.0, 0.0, 40.0),
                                              child: Text(
                                                'Get started by filling out the form below, and answer a few quick questions. ',
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  key: ValueKey('Button_ybnp'),
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'LOGIN_PAGE_SIGNUP_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_auth');
                                                    GoRouter.of(context)
                                                        .prepareAuthEvent();
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'LOGIN_PAGE_GoogleButton_ON_TAP');
                                                    logFirebaseEvent(
                                                        'GoogleButton_auth');
                                                    GoRouter.of(context)
                                                        .prepareAuthEvent();
