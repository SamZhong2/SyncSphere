...
export 'onboarding_info_model.dart';

class OnboardingInfoWidget extends StatefulWidget {
  const OnboardingInfoWidget({super.key});

  static String routeName = 'Onboarding_Info';
  static String routePath = '/onboardingInfo';

  @override
  State<OnboardingInfoWidget> createState() => _OnboardingInfoWidgetState();
}

class _OnboardingInfoWidgetState extends State<OnboardingInfoWidget> {
  late OnboardingInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingInfoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Onboarding_Info'});
          ...
          child: Column(
            ...
            children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ONBOARDING_INFO_ADD_BIRTHDAY_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('ONBOARDING_INFO_PAGE_NEXT_BTN_ON_TAP');
                    ...
                    context.pushNamed(
                      OnboardingEmailsWidget.routeName,
                  ...
                  text: 'Next',
                  options: FFButtonOptions(
                    width: MediaQuery.sizeOf(context).width * 0.209,
